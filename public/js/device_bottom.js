...
function view_data(){
    ...
    $('#view_device1').text(deviceId)
    $('#view_device2').text(make)
    $('#view_device3').text(model)
    $('#view_device4').text(simId)
    $('#view_device5').text(status)
...
async function simpan_data(){
    ...
    if (store_status==0){
        ...
        var deviceId = $('#t_deviceId').textbox('getValue')
        var make = $('#t_make').textbox('getValue')
        var model = $('#t_model').textbox('getValue')
        var simId = $('#t_simId').textbox('getValue')
        var status = $('#t_status').textbox('getValue')
